# table_of_customer_filter_name
 Таблица пользователей с фильтрацией по имени
 пример кода от 17.04.2021. Информация по тз есть также в файле readme в файлах. Написал за 3-4 дня, часов по 6, с перерывами. Первый мой такой сложный проект по JS, со своей логикой. Не смог реализовать debounce. На адаптив тоже не тратил время. Всё остальное реализовано по тз. Если есть обратная связь по коду, буду рад. Старался сделать максимально гибко, пока без ООП. Вопросов куча была в процессе написания.
